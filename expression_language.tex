...
\mid e / e \mid \texttt{true} \mid \texttt{false} \mid \\
  && e  =  e \mid e < e \mid e > e \mid e \leq e \mid e \geq e \mid 
     \ifelse{e}{e}{e} \mid \texttt{fix} (\lambda f.\lambda x.e) \\
\end{array}
\]
...
$\llbracket e[x \mapsto e']\rrbracket\eta = \llbracket e \rrbracket\eta\{x \mapsto \llbracket e' \rrbracket\eta\}$.
Let $\texttt{F} = \lambda f \lambda x.e$, and see that
\begin{align*}
\llbracket \lambda x.e[f \mapsto \texttt{fix}(\texttt{F})]\rrbracket\eta 
...
\begin{align*}
 fix(\llbracket \texttt{F} \rrbracket) &= fix(F) \\
