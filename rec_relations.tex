...
$h_2(x)(l)$. The arguments to these random variables, then, should be the left and right sublists themselves. 
 ...
 to write and type-check these recurrences.
 
 \[
\begin{array}{rcl}
\tau &::=& \texttt{real} \mid \texttt{nat} \mid \texttt{bool} \mid \texttt{list(n)} \mid \tau \times \tau \mid \tau \rightarrow \tau \mid \Pi x:\tau.\tau
\mid \tau \ e \\
